...
[4] Wang X, Wu T, Yang Y, **Zhou L**, Wang S, Liu J, Zhao Y, Zhang M, Zhao Y, Qu H, Kong H, Zhang Y. [Ultrasmall and highly biocompatible carbon dots derived from natural plant with amelioration against acute kidney injury](https://jnanobiotechnology.biomedcentral.com/articles/10.1186/s12951-023-01795-5)
        
        . *J Nanobiotechnology*. (Fourth author, IF=12.6)  
[5] Wu J, Li Z, Cai Y, Liang H, **Zhou L**, Chen M, Guan J. [A Novel Tongue Coating Segmentation Method Based on Improved TransUNet](https://www.mdpi.com/1424-8220/24/14/4455). *Sensors (Basel)*. (Fifth author, IF=3.5)</p>
[6] Zhao Y, Dai E, Dong L, Yuan J, Zhao Y, Wu T, Kong R, Li M, Wang S, **Zhou L**, Yang Y, Kong H, Zhao Y, Qu H. [Available and novel plant-based carbon dots derived from *Vaccaria Semen carbonisata* alleviates liver fibrosis](https://www.frontiersin.org/journals/molecular-biosciences/articles/10.3389/fmolb.2023.1282929/full)
        
        . *Front Mol Biosci*. (Tenth author, IF=5.0)  
